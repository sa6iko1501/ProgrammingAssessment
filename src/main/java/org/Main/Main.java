...
public class Main {
    ...
    private static List<Product> initiateProducts(){
        ...
        //We can add more products and the application will run normally but will require an extra input for the new product
    ...
    private static List<Client> initiateClients(){
        ...
        //We can add more clients and the application will run normally
